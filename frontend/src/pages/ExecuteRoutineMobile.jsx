...
const ExecuteRoutineMobile = () => {
  ...
  const handleFinishSession = async () => {
    ...
    try {
      ...
      exercises.forEach((exercise) => {
        enrichedExerciseData[exercise.id] = exerciseData[exercise.id].map(
          (serie) => ({
            ...serie,
      ...
      // ✅ NAVEGAR A WorkoutSummary PASANDO EL CONTEXTO DE PROGRESIÓN
      navigate("/WorkoutSumary", {
        state: {
          ...
          fromProgression: fromProgression, // ✅ PASAR ESTO
          completedDate: completedDate, // ✅ PASAR ESTO
        },
      });
    } catch (error) {
    ...
    <div className="min-h-screen bg-background flex flex-col pb-25">
      ...
      <section className="px-4 mt-4 flex flex-col gap-3">
        {exercises.map((exercise, index) => {
          ...
          const series = exerciseData[exercise.id] || [];
          const allCompleted =
            series.length > 0 && series.every((s) => s.completed);
          ...
          return (
            <Card key={exercise.id}>
              ...
              >
                <div
                  className={`h-12 w-12 rounded-xl flex items-center justify-center font-heading font-bold text-[18px] shrink-0 ${
                    allCompleted
                      ...
                      >
                        ...
                        <div>
                          <input
                            ...
                            step="0.5"
                            placeholder={
                              serie.targetWeight > 0
                                ? serie.targetWeight.toString()
                                : "0"
                            }
                          ...
                          subscriptionTier === "pro" ? (
                            ...
                            <div className="relative">
                              ...
                              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                                <span className="text-[10px] text-text-low/30">
                                  🔒
                                </span>
                              </div>
                            </div>
...
export default ExecuteRoutineMobile;
