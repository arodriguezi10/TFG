...
const ProgressionMobile = () => {
  ...
  const calculateCurrentWeek = (progression) => {
    ...
    setCurrentWeekIndex(Math.max(0, Math.min(weekIndex, progression.duration_weeks - 1)));
  };
      ...
      <div className="min-h-screen bg-background flex flex-col mb-2.5 px-4">
        <section className="w-full flex items-center justify-between">
          <div className="flex flex-col gap-1.25">
            <div className="flex gap-3.75"><p className="font-subheading text-[12px] text-text-low">Biblioteca</p></div>
            <h1 className="font-heading font-extrabold text-[28px] text-text-high flex flex-col leading-tight">Progresión</h1>
          </div>
        </section>
        <section className="mt-3 w-full border-b border-text-low">
          <div className="flex gap-8">
            <button onClick={() => navigate("/routines1")} className="pb-2 font-subheading font-semibold text-[15px] transition-all text-text-low hover:text-text-high">Rutinas</button>
            <button className="pb-2 font-subheading font-semibold text-[15px] transition-all text-accent1 relative">Progresión<div className="absolute bottom-0 left-0 right-0 h-0.5 bg-accent1"></div></button>
          </div>
        </section>
        <section className="mt-16 flex flex-col items-center justify-center gap-3.75 px-4">
          <div className="relative">
            <span className="bg-linear-to-br from-yellow/20 to-orange/20 h-32 w-32 rounded-[40px] font-body text-[70px] flex items-center justify-center border border-yellow/30"><Crown size={48} className="text-yellow" /></span>
            <div className="absolute -top-2 -right-2 bg-yellow h-8 w-8 rounded-full flex items-center justify-center text-[16px] animate-pulse"><Lightbulb size={16} className="text-background" /></div>
          </div>
          <p className="mt-2 bg-yellow-bg2 px-3.5 py-1 rounded-2xl border border-yellow font-subheading font-bold text-[14px] text-yellow">◆ FUNCIÓN ÉLITE</p>
          <p className="font-heading font-extrabold text-[32px] text-text-high leading-tight flex flex-col items-center justify-center text-center">Desbloquea la<span className="text-yellow">progresión automática</span></p>
          <p className="font-body text-[15px] text-text-low text-center max-w-sm">Planifica la evolución de tus cargas semana a semana con progresiones inteligentes diseñadas por tu entrenador.</p>
          <div className="mt-4 w-full flex flex-col gap-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1"><p className="font-heading font-bold text-[15px] text-text-high mb-0.5">Progresión inteligente</p><p className="font-body text-[13px] text-text-low">Incrementa peso y volumen de forma óptima cada semana</p></div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1"><p className="font-heading font-bold text-[15px] text-text-high mb-0.5">Ciclos personalizados</p><p className="font-body text-[13px] text-text-low">Crea mesociclos de 4-12 semanas adaptados a tus objetivos</p></div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1"><p className="font-heading font-bold text-[15px] text-text-high mb-0.5">Automatización completa</p><p className="font-body text-[13px] text-text-low">Olvídate de calcular, el sistema ajusta todo por ti</p></div>
            </div>
          </div>
        </section>
        <section className="mt-8 flex flex-col gap-3">
          ...
          <button onClick={() => navigate("/routines1")} className="w-full"><p className="font-body text-[14px] text-text-low text-center">Volver a rutinas</p></button>
        </section>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-background flex flex-col mb-2.5 px-4">
        <section className="w-full flex items-center justify-between">
          ...
          <div className="flex gap-2.5">
            <div className="bg-surf h-10 w-10 rounded-lg border border-white/27 flex items-center justify-center text-text-low">⚙️</div>
            <button onClick={() => navigate("/createProgression")} className="bg-accent1 h-10 w-10 rounded-lg border border-white/27 flex items-center justify-center text-text-high cursor-pointer hover:opacity-80 transition-opacity">+</button>
          </div>
        </section>
        <section className="mt-3 w-full border-b border-text-low">
          <div className="flex gap-8">
        ...
        <section className="mt-2"><p className="font-body text-[14px] text-text-low">0 progresiones activas</p></section>
        <section className="mt-12.5 flex flex-col items-center justify-center gap-3.75">
          ...
          <p className="mt-5 bg-surf px-3.5 py-0.5 rounded-2xl border border-text-low font-subheading font-semibold text-[16px] text-text-low">Sin progresiones todavía</p>
          <p className="font-heading font-extrabold text-[28px] text-text-high leading-tight flex flex-col items-center justify-center text-center">Crea tu primera<span className="text-accent1">progresión automática</span></p>
          ...
          <Card>
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-body text-[13px] text-text-low leading-relaxed">Una progresión es un plan estructurado que incrementa automáticamente tus cargas semana a semana basándose en rutinas existentes o nuevas.</p>
              </div>
            </div>
        ...
        <section className="mt-7.5 flex flex-col gap-2.5">
          <Button variant="outlined" text="Crear progresión" bgColor={"bg-accent1"} textColor={"text-text-high"} borderColor={"border-accent1"} w="w-[100%]" onClick={() => navigate("/createProgression")} />
        </section>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col mb-2.5 px-4">
      ...
      <section className="mt-4">
        <Card>
          <div className="flex items-center justify-between mb-3">
            <div className="flex-1">
              <p className="font-subheading font-bold text-[12px] text-text-low uppercase tracking-wide">Mesociclo activo</p>
              <h2 className="font-heading font-extrabold text-[24px] text-text-high mt-1 leading-tight">{activeProgression.name}</h2>
            ...
            <div className="bg-accent1 rounded-2xl px-4 py-3 flex flex-col items-center shrink-0">
              <p className="font-subheading font-bold text-[11px] text-text-high/80 uppercase">Semana</p>
              <p className="font-heading font-extrabold text-[32px] text-text-high leading-none">{currentWeekIndex + 1}</p>
            </div>
          </div>
        </Card>
      </section>
      ...
      <section className="mt-4">
        <div className="flex items-center justify-between mb-3">
          <p className="font-subheading font-bold text-[16px] text-text-low">SEMANA {currentWeekIndex + 1} DE {activeProgression.duration_weeks}</p>
          ...
          <Card className="mt-3">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: `${selectedDayDetail.color}20`, border: `1px solid ${selectedDayDetail.color}` }}>
                ...
                <div>
                  ...
                  <p className="font-heading font-bold text-[16px] text-text-high">{selectedDayDetail.routine.name}</p>
                </div>
              </div>
      ...
      <section className="mt-4">
        <Card>
          <div className="flex items-center justify-between mb-2">
            <p className="font-subheading font-bold text-[14px] text-text-low">PROGRESO DEL MESOCICLO</p>
            <p className="font-heading font-bold text-[16px] text-accent1">{Math.round(getProgressPercentage())}%</p>
          </div>
          ...
          <div className="flex items-center justify-between mt-2">
            <p className="font-body text-[12px] text-text-low">{completedDays.size} días completados</p>
            <p className="font-body text-[12px] text-text-low">{activeProgression.duration_weeks * 7} días totales</p>
          </div>
        </Card>
      </section>
      ...
      <section className="mt-4">
        <Card>
          <p className="font-subheading font-bold text-[14px] text-text-low mb-4">RESUMEN</p>
          <div className="grid grid-cols-3 gap-4">
            <div className="flex flex-col items-center">
              <div className="bg-accent1/10 h-12 w-12 rounded-xl border border-accent1 flex items-center justify-center mb-2"><Clock size={20} className="text-accent1" /></div>
              <p className="font-heading font-bold text-[20px] text-text-high">{activeProgression.duration_weeks}</p>
              <p className="font-body text-[11px] text-text-low text-center">Semanas totales</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-accent2/10 h-12 w-12 rounded-xl border border-accent2 flex items-center justify-center mb-2"><ClipboardList size={20} className="text-accent2" /></div>
              <p className="font-heading font-bold text-[20px] text-text-high">{progressionBlocks.length}</p>
              <p className="font-body text-[11px] text-text-low text-center">Rutinas en bloque</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-primary-bg h-12 w-12 rounded-xl border border-primary flex items-center justify-center mb-2"><Target size={20} className="text-primary" /></div>
              <p className="font-heading font-bold text-[20px] text-text-high capitalize">{activeProgression.goal}</p>
              <p className="font-body text-[11px] text-text-low text-center">Objetivo</p>
            </div>
          </div>
        </Card>
      </section>
...
export default ProgressionMobile;